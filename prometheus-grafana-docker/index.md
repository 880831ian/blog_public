...
{{< image src="/images/Prometheus-Grafana-Docker/run_1.png"  width="800" caption="啟動容器" src_s="/images/Prometheus-Grafana-Docker/run_1.png" src_l="/images/Prometheus-Grafana-Docker/run_1.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_2.png"  width="800" caption="檢查 Nginx 以及 nginx-prometheus-exporter 的設定" src_s="/images/Prometheus-Grafana-Docker/run_2.png" src_l="/images/Prometheus-Grafana-Docker/run_2.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_3.png"  width="1200" caption="檢查 Prometheus targets" src_s="/images/Prometheus-Grafana-Docker/run_3.png" src_l="/images/Prometheus-Grafana-Docker/run_3.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_4.png"  width="800" caption="Prometheus 內建的圖形化介面" src_s="/images/Prometheus-Grafana-Docker/run_4.png" src_l="/images/Prometheus-Grafana-Docker/run_4.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_5.png"  width="1200" caption="Prometheus 內建的圖形化介面" src_s="/images/Prometheus-Grafana-Docker/run_5.png" src_l="/images/Prometheus-Grafana-Docker/run_5.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_6.png"  width="800" caption="經過測試顯示的 nginx_connections_accepted 圖形" src_s="/images/Prometheus-Grafana-Docker/run_6.png" src_l="/images/Prometheus-Grafana-Docker/run_6.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_7.png"  width="1000" caption="Grafana 登入頁面" src_s="/images/Prometheus-Grafana-Docker/run_7.png" src_l="/images/Prometheus-Grafana-Docker/run_7.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_8.png"  width="1000" caption="Grafana 新增資料來源" src_s="/images/Prometheus-Grafana-Docker/run_8.png" src_l="/images/Prometheus-Grafana-Docker/run_8.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_9.png"  width="1000" caption="Grafana 新增資料來源" src_s="/images/Prometheus-Grafana-Docker/run_9.png" src_l="/images/Prometheus-Grafana-Docker/run_9.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_10.png"  width="1000" caption="Grafana 載入別人做好的儀表板" src_s="/images/Prometheus-Grafana-Docker/run_10.png" src_l="/images/Prometheus-Grafana-Docker/run_10.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_11.png"  width="1000" caption="Grafana 儀表板" src_s="/images/Prometheus-Grafana-Docker/run_11.png" src_l="/images/Prometheus-Grafana-Docker/run_11.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_12.png"  width="1000" caption="測試 Grafana 是否成功抓到資料" src_s="/images/Prometheus-Grafana-Docker/run_12.png" src_l="/images/Prometheus-Grafana-Docker/run_12.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/run_13.png"  width="1000" caption="測試暫停 Nginx 查看 Grafana 儀表板 NGINX Status" src_s="/images/Prometheus-Grafana-Docker/run_13.png" src_l="/images/Prometheus-Grafana-Docker/run_13.png" >}}
...
{{< admonition tip "怎麼使用 Telegram Bot">}}
...
{{< image src="/images/Prometheus-Grafana-Docker/alert_1.png"  width="1000" caption="Alerting 設定" src_s="/images/Prometheus-Grafana-Docker/alert_1.png" src_l="/images/Prometheus-Grafana-Docker/alert_1.png" >}}

<br>

{{< image src="/images/Prometheus-Grafana-Docker/alert_2.png"  width=600" caption="Alerting 測試結果" src_s="/images/Prometheus-Grafana-Docker/alert_2.png" src_l="/images/Prometheus-Grafana-Docker/alert_2.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/alert_3.png"  width=800" caption="Create Panel" src_s="/images/Prometheus-Grafana-Docker/alert_3.png" src_l="/images/Prometheus-Grafana-Docker/alert_3.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/alert_4.png"  width=1200" caption="設定 Panel" src_s="/images/Prometheus-Grafana-Docker/alert_4.png" src_l="/images/Prometheus-Grafana-Docker/alert_4.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/alert_5.png"  width=800" caption="設定好 Alert 的控制板" src_s="/images/Prometheus-Grafana-Docker/alert_5.png" src_l="/images/Prometheus-Grafana-Docker/alert_5.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/alert_6.png"  width=800" caption="超過閥值，控制板變成紅色" src_s="/images/Prometheus-Grafana-Docker/alert_6.png" src_l="/images/Prometheus-Grafana-Docker/alert_6.png" >}}
...
{{< image src="/images/Prometheus-Grafana-Docker/alert_7.png"  width=500" caption="自動發送通知到 Telegram Bot，並附上控制板圖片" src_s="/images/Prometheus-Grafana-Docker/alert_7.png" src_l="/images/Prometheus-Grafana-Docker/alert_7.png" >}}
