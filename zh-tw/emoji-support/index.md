...
Emoji 可以通過多種方式在 Hugo 項目中啟用.

<!--more-->

[`emojify`](https://gohugo.io/functions/emojify/) 方法可以直接在模板中調用, 或者使用[行內 Shortcodes](https://gohugo.io/templates/shortcode-templates#inline-shortcodes).

要全局使用 emoji, 需要在你的[網站配置](https://gohugo.io/getting-started/configuration/)中設置 `enableEmoji` 為 `true`,
然後你就可以直接在文章中輸入 emoji 的代碼.

它們以**冒號**開頭和結尾，並且包含 emoji 的 **代碼**:
